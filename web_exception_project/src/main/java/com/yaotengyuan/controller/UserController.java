...
import com.yaotengyuan.errorcode.YaotengyuanErrorCode;
...
public class UserController {
    ...
    public ModelAndView exceptionForPageJumps(HttpServletRequest request) throws Exception {
        throw new BusinessException(YaotengyuanErrorCode.NULL_OBJ);
    }
    ...
    public String checkLogin(String username, String password) {
        ...
        try {
            ...
            throw new BusinessException(
                    YaotengyuanErrorCode.LOGIN_VERIFY_FAILURE);
        }
